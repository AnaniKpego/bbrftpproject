 ...
 */
final class Version20200612080212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, subtitle VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, filename VARCHAR(255) NOT NULL, icon VARCHAR(255) DEFAULT NULL, price INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event_booking DROP FOREIGN KEY FK_655B44718B7E4006');
        $this->addSql('ALTER TABLE room_booking DROP FOREIGN KEY FK_C2E513E8B7E4006');
        $this->addSql('ALTER TABLE service_booking DROP FOREIGN KEY FK_2F88BF428B7E4006');
